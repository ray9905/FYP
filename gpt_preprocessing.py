...
#Bad channel detection based on variance
...
#Epoch creation with artifact rejection
...
for i, epoch in enumerate(epochs):
    ...
    fig.set_size_inches(24, 14)  #Sets figure size
    fig.savefig(f'{save_path}/epoch_{i+1}.png', dpi=300)  #Sets resolution of epochs
    plt.close(fig)

#Shows which channels cause epoch rejection
